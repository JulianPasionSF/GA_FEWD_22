...
let thePlanets = ['jupiter','mars','saturn','earth','uranus','venus','neptune','mercury','pluto']
...
for(let i=0; i<snacks.length; i++){
  ...
  document.querySelector("#exersize-four").innerText = "My favorite snack is " + snacks[i];
}
