...
const programmingIsCool = true; //Boolean
const clearancePrice = 1.99; //number
const lifeTheUniverseAndEverything = 42;  //number
const theCruelestMonth = "April"; //string

//console.log ("programmingIsCool is a " + typeof(true) )

console.log ("clearancePrice is a " + typeof(1.99))
