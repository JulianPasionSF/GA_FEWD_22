...
document.querySelector('#factsCharacteristics header').addEventListener('click',function(e){
    e.preventDefault();
    document.getElementById('factsCharacteristics').classList.toggle('factsAccordionCollapsed');
});

});

//Rock Paper Scissors game (card 5)
